...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "qtihocpy0jb8atov"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//补光灯(可下发可上报)
//备注:鱼缸LED补光灯
#define DPID_LED_LIGHT 101
//水温度(只上报)
//备注:鱼缸水温
#define DPID_WATER_TEMP 102
//水循环(可下发可上报)
//备注:水循环-水泵开关
//#define DPID_WATER_CIRCULATING 103
#define DPID_WATER_CIRCULATING 116
//环境温度(只上报)
//备注:环境温度
#define DPID_AIRTEMP 104
//周一(可下发可上报)
//备注:
#define DPID_MONDAY 105
//周二(可下发可上报)
//备注:
#define DPID_TUESDAY 106
//周三(可下发可上报)
//备注:
#define DPID_WEDNESDAY 107
//周四(可下发可上报)
//备注:
#define DPID_THURSDAY 108
//周五(可下发可上报)
//备注:
#define DPID_FRIDAY 109
//周六(可下发可上报)
//备注:
#define DPID_SATURDAY 110
//周日(可下发可上报)
//备注:
#define DPID_SUNDAY 111
//电池电量低(可下发可上报)
//备注:
#define DPID_BAT_LOW_SET 112
//手动喂食1次(可下发可上报)
//备注:
#define DPID_MANUAL_FEED_ONCE 113
//喂食时间—时(可下发可上报)
//备注:定时投喂时设置
#define DPID_TIME_H 114
//喂食时间-分(可下发可上报)
//备注:喂食时间-分钟设置
//
#define DPID_TIME_MIN 115
